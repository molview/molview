...
Jmol._version||(Jmol=function(b){var k=function(b){return{header:b++,rear:b++,main:b++,image:b++,front:b++,fileOpener:b++,coverImage:b++,dialog:b++,menu:b+9E4,console:b+91E3,monitorZIndex:b+99999}},k={_version:"$Date: 2014-10-19 20:12:48 -0500 (Sun, 19 Oct 2014) $",_alertNoBinary:!0,_allowedJmolSize:[25,2048,300],_fileCache:null,_jarFile:null,_j2sPath:null,_use:null,_j2sLoadMonitorOpacity:90,_applets:{},_asynchronous:!0,_ajaxQueue:[],_getZOrders:k,_z:k(Jmol.z||9E3),_debugCode:!0,db:{_databasePrefixes:"$=:",
...
"red")};q.err.println=function(b){n.consoleOutput("undefined"==typeof b?"\r\n":null==b?"null\r\n":b+"\r\n","red")};q.err.write=function(b,a,c){q.err.print(String.instantialize(b).substring(a,a+c))}}(Clazz))};Jmol.___JmolDate="$Date: 2014-11-10 16:58:19 -0600 (Mon, 10 Nov 2014) $";Jmol.___fullJmolProperties="src/org/jmol/viewer/Jmol.properties";Jmol.___JmolVersion="14.3.9_2014.11.11";
