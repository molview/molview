...
b){if(typeof b.getElementById!==ua&&W){var m=b.getElementById(a);return m&&m.parentNode?[m]:[]}},w.filter.ID=function(a){var b=a.replace(ca,da);return function(a){return a.getAttribute("id")===b}}):(delete w.find.ID,w.filter.ID=function(a){var b=a.replace(ca,da);return function(a){return(a=typeof a.getAttributeNode!==ua&&a.getAttributeNode("id"))&&a.value===b}});w.find.TAG=B.getElementsByTagName?function(a,b){if(typeof b.getElementsByTagName!==ua)return b.getElementsByTagName(a)}:function(a,b){var m,
...
c.innerHTML||"").replace(Cd,""))}l=c=null}return this}});h.each({appendTo:"append",prependTo:"prepend",insertBefore:"before",insertAfter:"after",replaceAll:"replaceWith"},function(a,b){h.fn[a]=function(a){for(var c=0,d=[],j=h(a),m=j.length-1;c<=m;c++)a=c===m?this:this.clone(!0),h(j[c])[b](a),ob.apply(d,a.get());return this.pushStack(d)}});var Aa,Ub={},Ha,$a,xa=u.createElement("div");xa.innerHTML="  <link/><table></table><a href='/a'>a</a><input type='checkbox'/>";Ha=xa.getElementsByTagName("a")[0];
...
h.parseJSON=function(a){if(b.JSON&&b.JSON.parse)return b.JSON.parse(a+"");var c,d=null,j=h.trim(a+"");return j&&!h.trim(j.replace(Nd,function(a,b,j,h){c&&b&&(d=0);if(0===d)return a;c=j||b;d+=!h-!j;return""}))?Function("return "+j)():h.error("Invalid JSON: "+a)};h.parseXML=function(a){var c,d;if(!a||"string"!==typeof a)return null;try{b.DOMParser?(d=new DOMParser,c=d.parseFromString(a,"text/xml")):(c=new ActiveXObject("Microsoft.XMLDOM"),c.async="false",c.loadXML(a))}catch(j){c=void 0}(!c||!c.documentElement||
...
Jmol._version||(Jmol=function(b){var k=function(b){return{header:b++,rear:b++,main:b++,image:b++,front:b++,fileOpener:b++,coverImage:b++,dialog:b++,menu:b+9E4,console:b+91E3,consoleImage:b+91001,monitorZIndex:b+99999}},k={_version:"$Date: 2015-03-01 07:13:29 -0600 (Sun, 01 Mar 2015) $",_alertNoBinary:!0,_allowedJmolSize:[25,2048,300],_appletCssClass:"",_appletCssText:"",_fileCache:null,_jarFile:null,_j2sPath:null,_use:null,_j2sLoadMonitorOpacity:90,_applets:{},_asynchronous:!0,_ajaxQueue:[],_getZOrders:k,
_z:k(Jmol.z||9E3),_debugCode:!0,db:{_databasePrefixes:"$=:",_fileLoadScript:";if (_loadScript = '' && defaultLoadScript == '' && _filetype == 'Pdb') { select protein or nucleic;cartoons Only;color structure; select * };",_nciLoadScript:";n = ({molecule=1}.length < {molecule=2}.length ? 2 : 1); select molecule=n;display selected;center selected;",_pubChemLoadScript:"",_DirectDatabaseCalls:{"cactus.nci.nih.gov":"%URL","www.rcsb.org":"%URL","pdbe.org":"%URL","www.ebi.ac.uk":"%URL","wwwdev.ebi.ac.uk":"%URL",
...
c))};b.$appEvent=function(a,c,d,e){a=b.$(a,c);a.off(d)&&e&&a.on(d,e)};b.$resize=function(a){return k(window).resize(a)};b.$after=function(a,b){return k(a).after(b)};b.$append=function(a,b){return k(a).append(b)};b.$bind=function(a,b,d){return d?k(a).bind(b,d):k(a).unbind(b)};b.$closest=function(a,b){return k(a).closest(b)};b.$get=function(a,b){return k(a).get(b)};b.$documentOff=function(a,b){return k(document).off(a,"#"+b)};b.$documentOn=function(a,b,d){return k(document).on(a,"#"+b,d)};b.$getAncestorDiv=
function(a,b){return k("div."+b+":has(#"+a+")")[0]};b.$supportsIECrossDomainScripting=function(){return k.support.iecors};b.$attr=function(a,c,d){return b._$(a).attr(c,d)};b.$css=function(a,c){return b._$(a).css(c)};b.$find=function(a,c){return b._$(a).find(c)};b.$focus=function(a){return b._$(a).focus()};b.$html=function(a,c){return b._$(a).html(c)};b.$offset=function(a){return b._$(a).offset()};b.$windowOn=function(a,b){return k(window).on(a,b)};b.$prop=function(a,c,d){var e=b._$(a);return 3==arguments.length?
e.prop(c,d):e.prop(c)};b.$remove=function(a){return b._$(a).remove()};b.$scrollTo=function(a,c){var d=b._$(a);return d.scrollTop(0>c?d[0].scrollHeight:c)};b.$setEnabled=function(a,c){return b._$(a).attr("disabled",c?null:"disabled")};b.$setSize=function(a,c,d){return b._$(a).width(c).height(d)};b.$setVisible=function(a,c){var d=b._$(a);return c?d.show():d.hide()};b.$submit=function(a){return b._$(a).submit()};b.$val=function(a,c){var d=b._$(a);return 1==arguments.length?d.val():d.val(c)};b._clearVars=
function(){delete jQuery;delete k;delete b;delete SwingController;delete J;delete JM;delete JS;delete JSV;delete JU;delete JV;delete java;delete javajs;delete Clazz;delete c$};var f=document,g=window,e={};e.ua=navigator.userAgent.toLowerCase();var n;a:{n=["linux","unix","mac","win"];for(var q=n.length;q--;)if(-1!=e.ua.indexOf(n[q])){n=n[q];break a}n="unknown"}e.os=n;e.browser=function(){for(var a=e.ua,b="konqueror webkit omniweb opera webtv icab msie mozilla".split(" "),d=0;d<b.length;d++)if(0<=a.indexOf(b[d]))return b[d];
...
b._mousePageY;this.container.css({top:b._mousePageY+"px",left:b._mousePageX+"px"})},a.mouseMove=function(a){if(this.isDragging&&b._mouseOwner==this){this.timestamp=System.currentTimeMillis();var d=this.pageX0+(a.pageX-this.pageX);a=this.pageY0+(a.pageY-this.pageY);b._mousePageX=d;b._mousePageY=a;this.container.css({top:a+"px",left:d+"px"})}},a.dragBind=function(a){this.applet._ignoreMouse=!a;this.container.unbind("mousemoveoutjsmol");this.container.unbind("touchmoveoutjsmol");this.container.unbind("mouseupoutjsmol");
this.container.unbind("touchendoutjsmol");b._setMouseOwner(null);if(a){var d=this;this.container.bind("mousemoveoutjsmol touchmoveoutjsmol",function(a,b,c){d.mouseMove(c)});this.container.bind("mouseupoutjsmol touchendoutjsmol",function(a,b,c){d.mouseUp(c)})}})};d.JSDialog=function(){};d.setDraggable(d.JSDialog);d.getScreenDimensions=function(a){a.width=k(window).width();a.height=k(window).height()};d.dispose=function(a){b.$remove(a.id+"_mover");delete d.htDialogs[a.id];a.container.obj.dragBind(!1)};
d.register=function(a,b){a.id=b+ ++d.count;d.htDialogs[a.id]=a};d.setDialog=function(a){b._setMouseOwner(null);b.$remove(a.id);var c=a.id+"_mover",j=b._$(c),e;j[0]?(j.html(a.html),e=j[0].jd):(b.$after("body","<div id='"+c+"' style='position:absolute;left:0px;top:0px;'>"+a.html+"</div>"),e=new d.JSDialog,j=b._$(c),a.container=j,e.applet=a.manager.vwr.html5Applet,e.setContainer(j),e.dialog=a,e.setPosition(),e.dragBind(!0),j[0].jd=e);b.$bind("#"+a.id+" .JButton","mousedown touchstart",function(){e.ignoreMouse=
!0});b.$bind("#"+a.id+" .JComboBox","mousedown touchstart",function(){e.ignoreMouse=!0});b.$bind("#"+a.id+" .JCheckBox","mousedown touchstart",function(){e.ignoreMouse=!0});b.$bind("#"+a.id+" .JTextField","mousedown touchstart",function(){e.ignoreMouse=!0});b.$bind("#"+a.id+" .JTable","mousedown touchstart",function(){e.ignoreMouse=!0});b.$bind("#"+a.id+" .JScrollPane","mousedown touchstart",function(){e.ignoreMouse=!0});b.$bind("#"+a.id+" .JEditorPane","mousedown touchstart",function(){e.ignoreMouse=
!0})};d.setSelected=function(a){b.$prop(a.id,"checked",!!a.selected)};d.setSelectedIndex=function(a){b.$prop(a.id,"selectedIndex",a.selectedIndex)};d.setText=function(a){b.$prop(a.id,"value",a.text)};d.setVisible=function(a){b.$setVisible(a.id,a.visible)};d.setEnabled=function(a){b.$setEnabled(a.id,a.enabled)};d.click=function(a,c){var e=d.htDialogs[a.id];if(e){var f=e.toString();if(0<=f.indexOf("JCheck"))e.selected=a.checked;else if(0<=f.indexOf("JCombo"))e.selectedIndex=a.selectedIndex;else if(null!=
e.text&&(e.text=a.value,c&&13!=(c.charCode||c.keyCode)))return}f=d.htDialogs[b.$getAncestorDiv(a.id,"JDialog").id];f.manager.actionPerformed(e?e.name:f.registryKey+"/"+a.id)};d.setFront=function(a){var c=a.manager.vwr.html5Applet;a.zIndex!=b._getZ(c,"dialog")&&(a.zIndex=b._incrZ(c,"dialog"));a.container&&((a.container[0]||a.container).style.zIndex=a.zIndex)};d.hideMenus=function(a){if(a=a._menus)for(var b in a)a[b].visible&&d.hideMenu(a[b])};d.windowClosing=function(a){a=d.htDialogs[b.$getAncestorDiv(a.id,
"JDialog").id];a.registryKey?a.manager.processWindowClosing(a.registryKey):a.dispose()};b._track=function(a){if(b._tracker){try{var c='<iframe style="display:none" width="0" height="0" frameborder="0" tabindex="-1" src="'+(b._tracker+"&applet="+a._jmolType+"&version="+b._version+"&appver="+b.___JmolVersion+"&url="+encodeURIComponent(document.location.href))+'"></iframe>';b.$after("body",c)}catch(d){}delete b._tracker}return a};b.getProfile=function(){window["j2s.doProfile"]=!0;if(self.Clazz&&self.JSON)return Clazz._profile||
(Clazz._profile={}),Clazz.getProfile()};b._getInChIKey=function(a,b){0<=b.indexOf("MOL=")&&b.split("MOL=")[1].split('"')};b._getAttr=function(a,b){var d=a.indexOf(b+"=");return 0<=d&&0<=(d=a.indexOf('"',d))?a.substring(d+1,a.indexOf('"',d+1)):null};b.User={viewUpdatedCallback:null};b.View={count:0,applets:{},sets:{}};(function(a){a.updateView=function(c,d){if(null!=c._viewSet){d.chemID||(c._searchQuery=null);d.data||(d.data="N/A");d.type=c._viewType;if(null==(c._currentView=a.__findView(c._viewSet,
d)))c._currentView=a.__createViewSet(c._viewSet,d.chemID,d.viewID||d.chemID);c._currentView[d.type].data=d.data;c._currentView[d.type].smiles=c._getSmiles();b.User.viewUpdatedCallback&&b.User.viewUpdatedCallback(c,"updateView");a.__setView(c._currentView,c,!1)}};a.updateFromSync=function(c,d){c._updateMsg=d;var e=b._getAttr(d,"sourceID")||b._getAttr(d,"file");if(e){var f=a.__findView(c._viewSet,{viewID:e});if(null==f)return b.updateView(c,d);f!=c._currentView&&a.__setView(f,c,!0);var l=(e=b._getAttr(d,
"atoms"))&&0<=d.indexOf("selectionhalos ON")?eval("["+e+"]"):[];setTimeout(function(){c._currentView==f&&a.updateAtomPick(c,l)},10);b.User.viewUpdatedCallback&&b.User.viewUpdatedCallback(c,"updateFromSync")}};a.updateAtomPick=function(a,d){var e=a._currentView;if(null!=e){for(var f in e)"info"!=f&&e[f].applet!=a&&e[f].applet._updateAtomPick(d);b.User.viewUpdatedCallback&&b.User.viewUpdatedCallback(a,"updateAtomPick")}};a.dumpViews=function(b){var d=a.sets[b];if(d){var e="View set "+b+":\n";b=a.applets[b];
for(var f in b)e+="\napplet "+b[f]._id+" currentView="+(b[f]._currentView?b[f]._currentView.info.viewID:null);for(f=d.length;0<=--f;){b=d[f];var e=e+("\n\n<b>view="+f+" viewID="+b.info.viewID+" chemID="+b.info.chemID+"</b>\n"),l,g;for(g in b)"info"!=g&&(e+="\nview="+f+" type="+g+" applet="+((l=b[g]).applet?l.applet._id:null)+" SMILES="+l.smiles+"\n atomMap="+JSON.stringify(l.atomMap)+"\n data=\n"+l.data+"\n")}return e}};a.__init=function(b){var d=b._viewSet,e=a.applets;e[d]||(e[d]={});e[d][b._viewType]=
b};a.__findView=function(b,d){var e=a.sets[b];null==e&&(e=a.sets[b]=[]);for(var f=e.length;0<=--f;){var l=e[f];if(d.viewID){if(l.info.viewID==d.viewID)return l}else{if(null!=d.chemID&&d.chemID==l.info.chemID)return l;for(var g in l)if("info"!=g&&(null!=d.data&&null!=l[g].data?d.data==l[g].data:d.type==g))return l}}return null};a.__createViewSet=function(c,d,e){a.count++;d={info:{chemID:d,viewID:e||"model_"+a.count}};for(var f in b._applets)e=b._applets[f],e._viewSet==c&&(d[e._viewType]={applet:e,
data:null});a.sets[c].push(d);return d};a.__setView=function(a,b,d){for(var e in a)if("info"!=e){var l=a[e],f=l.applet,g=d||null!=f&&"<modified>"==f._molData;if(!(null==f||f==b&&!g)){var n=null==l.data,k=null!=f._currentView;f._currentView=a;if(!k||!(a[e].data==l.data&&!n&!g))if(f._loadModelFromView(a),n)break}}}})(b.View);b.Cache={fileCache:{}};b.Cache.get=function(a){return b.Cache.fileCache[a]};b.Cache.put=function(a,c){b.Cache.fileCache[a]=c};b.Cache.setDragDrop=function(a){b.$appEvent(a,"appletdiv",
...
j.endsWith(".spt")||a._applet.cacheFileByName("cache://DROP_*",!1);"JSV"==a._viewType||j.endsWith(".jdx")?b.Cache.put(j,d):a._applet.cachePut(j,d);(d=b._jsGetXY(a._canvas,c))&&(!a._applet.setStatusDragDropped||a._applet.setStatusDragDropped(0,d[0],d[1],j))&&a._applet.openFileAsyncSpecial(j,1)}},d.readAsArrayBuffer(e)})}})(Jmol,jQuery);Jmol._debugCode=!1;
...
b.getParamsType=function(d){var a=d.length;switch(a){case 0:var c=["void"];c.typeString="\\void";return c;case 1:if((c=d[0])&&"number"==typeof c)return c=["Number"],c.typeString="\\Number",c}c=[];c.hasCastedNull=!1;if(d)for(var e=0;e<a;e++)c[e]=b.getClassName(d[e]),d[e]instanceof b.CastedNull&&(c.hasCastedNull=!0);c.typeString="\\"+c.join("\\");return c};b.searchAndExecuteMethod=function(d,a,c,e){var f=d[c],g=b.getParamsType(e);b._profile&&b.addProfile(a,c,g);if(f.lastParams==g.typeString&&f.lastClaxxRef===
a){if(g.hasCastedNull){a=[];for(c=0;c<e.length;c++)a[c]=e[c]instanceof b.CastedNull?null:e[c]}else a=e;return f.lastMethod?f.lastMethod.apply(d,a):null}f.lastParams=g.typeString;f.lastClaxxRef=a;var l=f.stacks;l||(l=a.prototype[c].stacks);for(var k=!1,n=l.length;0<=--n;)if(k||l[n]===a){k=b.tryToSearchAndExecute(c,d,l[n].prototype[c],g,e,f);if(!(k instanceof b.MethodException))return k;k=!0}if("construct"!=c)throw new b.MethodNotFoundException(d,a,c,g.typeString);};b.tryToSearchAndExecute=function(d,
a,c,e,f,g){var l=[];d=!0;for(var k in c)if(92==k.charCodeAt(0)){var n=k.substring(1).split("\\");n.length==e.length&&l.push(n);d=!1}else if(d&&"funParams"==k&&c.funParams){k=c.funParams;n=k.substring(1).split("\\");n.length==e.length&&(l[0]=n);break}if(0==l.length)return new b.MethodException;if(l=b.searchMethod(l,e)){k=null;k=d?c:c["\\"+l];c=null;if(e.hasCastedNull){c=[];for(e=0;e<f.length;e++)c[e]=f[e]instanceof b.CastedNull?null:f[e]}else c=f;g.lastMethod=k;return k.apply(a,c)}return new b.MethodException};
b._initializingException=!1;b.searchMethod=function(d,a){for(var c=[],e=d.length,f=0;f<e;f++){for(var g=[],l=!0,k=d[f].length,n=0;n<k;n++)if(g[n]=b.getInheritedLevel(a[n],d[f][n]),0>g[n]){l=!1;break}l&&(g[a.length]=f,c.push(g))}if(0==c.length)return null;e=c[0];for(f=1;f<c.length;f++){g=!0;for(n=0;n<a.length;n++)if(e[n]<c[f][n]){g=!1;break}g&&(e=c[f])}return d[e[a.length]].join("\\")};b.generateDelegatingMethod=function(b,a){var c=function(){var a=arguments;return SAEM(this,a.callee.claxxReference,
a.callee.methodName,a)};c.methodName=a;c.claxxReference=b;return c};SAEM=b.searchAndExecuteMethod;b.expExpandParameters=function(b,a){switch(a){case "N":return"Number";case "B":return"Boolean";case "S":return"String";case "O":return"Object";case "A":return"Array"}return"Unknown"};b.formatParameters=function(d){return d?d.replace(/~([NABSO])/g,b.expExpandParameters).replace(/\s+/g,"").replace(/^|,/g,"\\").replace(/\$/g,"org.eclipse.s"):"\\void"};b.overrideMethod=function(d,a,c,e){b.assureInnerClass&&
b.assureInnerClass(d,c);c.exName=a;e=b.formatParameters(e);c.funParams=e;c.claxxOwner=d;return b.getSignature(d.prototype,a,c,!0)};b.defineMethod=function(d,a,c,e){b.assureInnerClass&&b.assureInnerClass(d,c);c.exName=a;e=b.formatParameters(e);var f=d.prototype,g=b.getSignature(f,a,c,!1);if(!g||g.claxxOwner===d&&g.funParams==e)return c.funParams=e,c.claxxOwner=d,c.exClazz=d,b.getSignature(f,a,c,!0);var l=null,k=[];g.stacks?k=g.stacks:(l=g,g.claxxOwner&&(k[0]=l.claxxOwner));if(!g.stacks||g.claxxReference!==
d){g=b.getSignature(f,a,b.generateDelegatingMethod(d,a,g),!0);a=[];for(f=0;f<k.length;f++)a[f]=k[f];g.stacks=a}k=g.stacks;0>b.findArrayItem(k,d)&&k.push(d);l&&(l.claxxOwner===d?(g[l.funParams]=l,l.claxxOwner=null,l.funParams=null):l.claxxOwner||(g["\\unknown"]=l));c.exClazz=d;g[e]=c;return g};b.makeConstructor=function(d,a,c){b.defineMethod(d,"construct",a,c);d.con$truct&&(d.con$truct.index=d.con$truct.stacks.length)};b.overrideConstructor=function(d,a,c){b.overrideMethod(d,"construct",a,c);d.con$truct&&
(d.con$truct.index=d.con$truct.stacks.length)};b.allPackage={};b.allClasses={};b.lastPackageName=null;b.lastPackage=null;b.unloadedClasses=[];b.declarePackage=function(d){if(b.lastPackageName==d)return b.lastPackage;if(d&&d.length){for(var a=d.split(/\./),c=b.allPackage,e=0;e<a.length;e++)c[a[e]]||(c[a[e]]={__PKG_NAME__:c.__PKG_NAME__?c.__PKG_NAME__+"."+a[e]:a[e]},0==e&&b.setGlobal(a[e],c[a[e]])),c=c[a[e]];b.lastPackageName=d;return b.lastPackage=c}};b.evalType=function(d,a){var c=d.lastIndexOf(".");
if(-1!=c){var e=d.substring(0,c),e=b.declarePackage(e),c=d.substring(c+1);return e[c]}if(a)return window[d];switch(d){case "string":return String;case "number":return Number;case "object":return b._O;case "boolean":return Boolean;case "function":return Function;case "void":case "undefined":case "unknown":return d;case "NullObject":return NullObject;default:return window[d]}};b.defineType=function(d,a,c,e){var f=b.unloadedClasses[d];f&&(a=f);f=d.lastIndexOf(".");if(-1!=f){var g=d.substring(0,f),g=
b.declarePackage(g),f=d.substring(f+1);if(g[f])return g[f];g[f]=a}else{if(window[d])return window[d];b.setGlobal(d,a)}b.decorateAsType(a,d,c,e);d=b._innerFunctions;a.defineMethod=d.defineMethod;a.defineStaticMethod=d.defineStaticMethod;a.makeConstructor=d.makeConstructor;return a};b.isSafari=-1!=navigator.userAgent.indexOf("Safari");b.isSafari4Plus=!1;if(b.isSafari){var k=navigator.userAgent,f=k.indexOf("Version/");-1!=f&&(k=k.substring(f+8),k=parseFloat(k),b.isSafari4Plus=4<=k)}b.instantialize=function(d,
a){if(!a||!(1==a.length&&a[0]&&a[0]instanceof b.args4InheritClass)){d instanceof Number&&(d.valueOf=function(){return this});if(b.isSafari4Plus){for(var c=[],e=0;e<a.length;e++)c[e]=a[e];a=c}(c=d.construct)?d.con$truct?d.getClass().superClazz?c.claxxOwner&&c.claxxOwner===d.getClass()||c.stacks&&c.stacks[c.stacks.length-1]==d.getClass()?c.apply(d,a):(c.claxxOwner&&!c.claxxOwner.superClazz&&c.claxxOwner.con$truct?c.claxxOwner.con$truct.apply(d,[]):c.stacks&&(1==c.stacks.length&&!c.stacks[0].superClazz)&&
c.stacks[0].con$truct.apply(d,[]),c.apply(d,a),d.con$truct.apply(d,[])):(d.con$truct.apply(d,[]),c.apply(d,a)):c.apply(d,a):d.con$truct&&d.con$truct.apply(d,[])}};b.innerFunctionNames="equals hashCode getName getClassLoader getResource getResourceAsStream defineMethod defineStaticMethod makeConstructor".split(" ");b._innerFunctions={equals:function(b){return this===b},hashCode:function(){return this.getName().hashCode()},toString:function(){return"class "+this.getName()},getName:function(){return b.getClassName(this,
!0)},getClassLoader:function(){var d=this.__CLASS_NAME__,a=b._Loader.getClasspathFor(d),c=a.lastIndexOf(d.replace(/\./g,"/")),a=-1!=c?a.substring(0,c):b._Loader.getClasspathFor(d,!0),d=b._Loader.requireLoaderByBase(a);d.getResourceAsStream=b._innerFunctions.getResourceAsStream;d.getResource=b._innerFunctions.getResource;return d},getResource:function(b){return this.getResourceAsStream(b).url},getResourceAsStream:function(d){if(!d)return null;var a=null;java.io.InputStream?a=new java.io.InputStream:
(a=new b._O,a.__CLASS_NAME__="java.io.InputStream",a.close=NullObject);a.read=function(){return 0};d=d.replace(/\\/g,"/");var c=null,e=this.__CLASS_NAME__;2==arguments.length&&0!=d.indexOf("/")&&(d="/"+d);if(0==d.indexOf("/"))if(2==arguments.length?(c=arguments[1])||(c=b._Loader.binaryFolders[0]):b._Loader&&(c=b._Loader.getClasspathFor(e,!0)),c){var c=c.replace(/\\/g,"/"),f=c.length,f=c.charAt(f-1);"/"!=f&&(c+="/");a.url=c+d.substring(1)}else a.url=d.substring(1);else{if(this.base)c=this.base;else if(b._Loader)if(c=
b._Loader.getClasspathFor(e),f=c.lastIndexOf(e.replace(/\./g,"/")),-1!=f)c=c.substring(0,f);else if(f=-1,c.indexOf(".z.js")==c.length-5&&-1!=(f=c.lastIndexOf("/")))for(var c=c.substring(0,f+1),f=e.split(/\./),g=1;g<f.length;g++){for(var l="/",k=0;k<g;k++)l+=f[k]+"/";if(l.length>c.length)break;if(c.indexOf(l)==c.length-l.length){c=c.substring(0,c.length-l.length+1);break}}else c=b._Loader.getClasspathFor(e,!0);else(f=b.binaryFolders)&&f.length&&(c=f[0]);c||(c="j2s/");c=c.replace(/\\/g,"/");f=c.length;
f=c.charAt(f-1);"/"!=f&&(c+="/");this.base?a.url=c+d:(f=e.lastIndexOf("."),a.url=-1==f||this.base?c+d:c+e.substring(0,f).replace(/\./g,"/")+"/"+d)}return a},defineMethod:function(d,a,c){b.defineMethod(this,d,a,c)},defineStaticMethod:function(d,a,c){b.defineMethod(this,d,a,c);this[d]=this.prototype[d]},makeConstructor:function(d,a){b.makeConstructor(this,d,a)}};b.decorateFunction=function(d,a,c){var e;a?a.__PKG_NAME__?(e=a.__PKG_NAME__+"."+c,a[c]=d,a===java.lang&&b.setGlobal(c,d)):(e=a.__CLASS_NAME__+
"."+c,a[c]=d):(e=c,b.setGlobal(c,d));b.extendJO(d,e);a=b.innerFunctionNames;for(c=0;c<a.length;c++)d[a[c]]=b._innerFunctions[a[c]];b._Loader&&(d=b._Loader.findClass(e))&&d.status==b._Node.STATUS_KNOWN&&window.setTimeout(function(a){return function(){b._Loader.updateNode(a)}}(d),1)};b.currentPath="";b.declareInterface=function(d,a,c){var e=function(){};b.decorateFunction(e,d,a);c&&b.implementOf(e,c);return e};b.decorateAsClass=function(d,a,c,e,f,g){var l=null;a&&(l=a.__PKG_NAME__,l||(l=a.__CLASS_NAME__));
(l=b.unloadedClasses[(l?l+".":"")+c])&&(d=l);b.decorateFunction(d,a,c);g?b.inheritClass(d,e,g):e&&b.inheritClass(d,e);f&&b.implementOf(d,f);return d};b.declareType=function(d,a,c,e,f){return b.decorateAsClass(function(){b.instantialize(this,arguments)},d,a,c,e,f)};b.declareAnonymous=function(d,a,c,e,f){return b.decorateAsClass(function(){b.prepareCallback(this,arguments);b.instantialize(this,arguments)},d,a,c,e,f)};b.decorateAsType=function(d,a,c,e,f,g){b.extendJO(d,a);d.equals=b._innerFunctions.equals;
d.getName=b._innerFunctions.getName;if(g)for(a=0;a<b.innerFunctionNames.length;a++)g=b.innerFunctionNames[a],d[g]=b._innerFunctions[g];f?b.inheritClass(d,c,f):c&&b.inheritClass(d,c);e&&b.implementOf(d,e);return d};b._ex_reg=function(b,a,c){c||(c="[^\\s]+");var e=b.indexOf(a);b=b.substring(0,e)+c+b.substring(e+a.length);return RegExp("^"+b+"$")};try{null.hello()}catch(g){/Opera[\/\s](\d+\.\d+)/.test(navigator.userAgent)?(k=g.message.indexOf(":"),f=g.message.indexOf(":",k+2),b._NPEMsgFragment=g.message.substr(k+
1,f-k-20),b._isNPEExceptionPredicate=function(d){return-1!=d.message.indexOf(b._NPEMsgFragment)}):-1!=navigator.userAgent.toLowerCase().indexOf("webkit")?(b._exceptionNPERegExp=b._ex_reg(g.message,"hello"),b._isNPEExceptionPredicate=function(d){return b._exceptionNPERegExp.test(d.message)}):(b._exceptionNPERegExp=b._ex_reg(g.message,"$$o$$"),b._isNPEExceptionPredicate=function(d){return b._exceptionNPERegExp.test(d.message)})}b.exceptionOf=function(d,a){return d.__CLASS_NAME__?b.instanceOf(d,a):a==
Error?(0<=(""+d).indexOf("Error")&&System.out.println(b.getStackTrace()),0<=(""+d).indexOf("Error")):a==Exception||a==Throwable||a==NullPointerException&&b._isNPEExceptionPredicate(d)};b.getStackTrace=function(b){b||(b=25);for(var a="\n",c=arguments.callee.caller,e=0;e<b&&c;e++)a+=e+" "+(c.exName?(c.claxxOwner?c.claxxOwner.__CLASS_NAME__+".":"")+c.exName:c.toString?c.toString().substring(0,c.toString().indexOf("{")):"<native method>")+"\n",c=c.caller;return a};Number.prototype._numberToString=Number.prototype.toString;
b.declarePackage("java.io");b.declarePackage("java.lang.annotation");b.declarePackage("java.lang.instrument");b.declarePackage("java.lang.management");b.declarePackage("java.lang.reflect");b.declarePackage("java.lang.ref");java.lang.ref.reflect=java.lang.reflect;b.declarePackage("java.util");b.declareInterface(java.io,"Closeable");b.declareInterface(java.io,"DataInput");b.declareInterface(java.io,"DataOutput");b.declareInterface(java.io,"Externalizable");b.declareInterface(java.io,"Flushable");b.declareInterface(java.io,
"Serializable");b.declareInterface(java.lang,"Iterable");b.declareInterface(java.lang,"CharSequence");b.declareInterface(java.lang,"Cloneable");b.declareInterface(java.lang,"Appendable");b.declareInterface(java.lang,"Comparable");b.declareInterface(java.lang,"Runnable");b.declareInterface(java.util,"Comparator");java.lang.ClassLoader={__CLASS_NAME__:"ClassLoader"};if(window.Clazz&&!window.Clazz.unloadClass){b.MethodNotFoundException=function(d,a,c,e){d="";e&&(d=e.substring(1).replace(/\\/g,","));
this.message=(c&&"construct"!=c?"Method":"Constructor")+" "+b.getClassName(a,!0)+"."+c+"("+d+") is not found!";this.toString=function(){return"MethodNotFoundException:"+this.message}};b.prepareCallback=function(d,a){var c=a[0];if(d&&c&&c!==window){var e=b.getClassName(c,!0),f={};if(d.b$)for(var g in d.b$)f[g]=d.b$[g];d.b$=f;f[e]=c;for(e=b.getClass(c);e.superClazz;)e=e.superClazz,f[b.getClassName(e,!0)]=c;if(c=c.b$)for(g in c)f[g]=c[g]}for(f=0;f<a.length-1;f++)a[f]=a[f+1];a.length--};b.innerTypeInstance=
function(d,a,c){d||(d=arguments.callee.caller);var e;if(c||a.$finals)if(e=new d(a,b.inheritArgs),c)if(a.f$){var f={},g;for(g in a.f$)f[g]=a.f$[g];for(g in c)f[g]=c[g];e.f$=f}else e.f$=c;else a.f$&&(e.f$=a.f$);else switch(arguments.length){case 3:return new d(a);case 4:return a.__CLASS_NAME__==d.__CLASS_NAME__&&arguments[3]===b.inheritArgs?a:new d(a,arguments[3]);case 5:return new d(a,arguments[3],arguments[4]);case 6:return new d(a,arguments[3],arguments[4],arguments[5]);case 7:return new d(a,arguments[3],
arguments[4],arguments[5],arguments[6]);case 8:return new d(a,arguments[3],arguments[4],arguments[5],arguments[6],arguments[7]);case 9:return new d(a,arguments[3],arguments[4],arguments[5],arguments[6],arguments[7],arguments[8]);case 10:return new d(a,arguments[3],arguments[4],arguments[5],arguments[6],arguments[7],arguments[8],arguments[9]);default:e=new d(a,b.inheritArgs)}g=arguments.length-3;for(f=Array(g);0<=--g;)f[g]=arguments[g+3];b.instantialize(e,f);return e};b.cloneFinals=function(){for(var b=
{},a=arguments.length/2;0<=--a;)b[arguments[a+a]]=arguments[a+a+1];return b};b.isClassDefined=b.isDefinedClass=function(d){if(!d)return!1;if(b.allClasses[d])return!0;for(var a=d.split(/\./),c=null,e=0;e<a.length;e++)if(!(c=c?c[a[e]]:b.allPackage[a[0]]))return!1;return c&&(b.allClasses[d]=!0)};b.defineEnumConstant=function(b,a,c,e,f){f=f?new f:new b;f.$name=a;f.$ordinal=c;e&&e.length&&f.construct.apply(f,e);b[a]=f;b.prototype[a]=f;b["$ values"]||(b["$ values"]=[],b.values=function(){return this["$ values"]});
b["$ values"].push(f);return f};b.floatToInt=function(b){return 0>b?Math.ceil(b):Math.floor(b)};b.floatToByte=b.floatToShort=b.floatToLong=b.floatToInt;b.doubleToByte=b.doubleToShort=b.doubleToLong=b.doubleToInt=b.floatToInt;b.floatToChar=function(b){return String.fromCharCode(0>b?Math.ceil(b):Math.floor(b))};b.doubleToChar=b.floatToChar;self.Int32Array&&self.Int32Array!=Array?(b.haveInt32=!0,Int32Array.prototype.sort||(Int32Array.prototype.sort=Array.prototype.sort)):(Int32Array=function(b){b||(b=
0);var a=Array(b);a.toString=function(){return"[object Int32Array]"};for(var c=0;c<b;c++)a[c]=0;return a},b.haveInt32=!1,Int32Array.prototype.sort=Array.prototype.sort,Int32Array.prototype.int32Fake=function(){});self.Float64Array&&self.Float64Array!=Array?(b.haveFloat64=!0,Float64Array.prototype.sort||(Float64Array.prototype.sort=Array.prototype.sort)):(b.haveFloat64=!1,Float64Array=function(b){b||(b=0);for(var a=Array(b),c=0;c<b;c++)a[c]=0;return a},Float64Array.prototype.sort=Array.prototype.sort,
Float64Array.prototype.float64Fake=function(){},Float64Array.prototype.toString=function(){return"[object Float64Array]"});b.newArray=function(){if(arguments[0]instanceof Array)var d=arguments[0],a=arguments[1];else d=arguments,a=Array;var c=d[0];"string"==typeof c&&(c=c.charCodeAt(0));var e=d.length-1,f=d[e];switch(d.length){case 0:case 1:return[];case 2:if(null==f)return Array(c);if(!0===a&&b.haveInt32)return new Int32Array(c);if(!1===a&&b.haveFloat64)return new Float64Array(c);for(var d=!0===a?
new Int32Array:!1===a?new Float64Array:0>c?f:Array(c),g=c;0<=--g;)d[g]=f;return d;default:for(var l=Array(e),g=0;g<e;g++)l[g]=d[g+1];d=Array(c);if(null==f||0<=f||2<e)for(g=0;g<c;g++)d[g]=b.newArray(l,a);return d}};b.newArray32=function(d,a){var c=d[0];"string"==typeof c&&(c=c.charCodeAt(0));var e=d.length-1,f=d[e];switch(d.length){case 0:case 1:return alert("ERROR IN newArray32 -- args.length < 2"),[];case 2:if(e=0>c)c=f.length;var g=0>f?Array(c):a?new Int32Array(c):new Float64Array(c);if(e)for(e=
c;0<=--e;)g[e]=f[e];return g}for(f=Array(e);0<=--e;)f[e]=d[e+1];g=Array(c);for(e=0;e<c;e++)g[e]=b.newArray(f,a);return g};b.newInt32Array=function(){return b.newArray32(arguments,!0)};b.newFloat64Array=function(){return b.newArray32(arguments,!1)};b.newFloatArray=b.newDoubleArray=b.newFloat64Array;b.newIntArray=b.newLongArray=b.newShortArray=b.newByteArray=b.newInt32Array;b.newCharArray=b.newBooleanArray=b.newArray;b.arrayIs=function(b,a){return b.constructor&&b.constructor!=Number&&0<=b.constructor.toString().indexOf(a)};
b.isAS=function(d){return d&&"object"==typeof d&&b.arrayIs(d," Array")&&("string"==typeof d[0]||"undefined"==typeof d[0])};b.isASS=function(d){return d&&"object"==typeof d&&b.isAS(d[0])};b.isAP=function(d){return d&&"JU.P3"==b.getClassName(d[0])};b.isAI=function(d){return d&&"object"==typeof d&&(b.haveInt32?b.arrayIs(d,"Int32Array"):d.int32Fake?!0:!1)};b.isAII=function(d){return d&&"object"==typeof d&&b.isAI(d[0])};b.isAF=function(d){return d&&"object"==typeof d&&(b.haveFloat64?b.arrayIs(d,"Float64Array"):
d.float64Fake?!0:!1)};b.isAFF=function(d){return d&&"object"==typeof d&&b.isAF(d[0])};b.isAFFF=function(d){return d&&"object"==typeof d&&b.isAFF(d[0])};b.isAFloat=function(d){return d&&"object"==typeof d&&b.arrayIs(d," Array")&&b.instanceOf(d[0],Float)};b.defineStatics=function(b){for(var a=arguments.length,c=(a-1)/2;0<=--c;){var e=arguments[--a],f=arguments[--a];b[f]=b.prototype[f]=e}};b.prepareFields=function(d,a){var c=[];if(d.con$truct)for(var e=d.con$truct.stacks,f=0;f<e.length;f++)c[f]=e[f];
b.addProto(d.prototype,"con$truct",d.con$truct=function(){var a=arguments.callee.stacks;if(a)for(var b=0;b<a.length;b++)a[b].apply(this,[])});c.push(a);d.con$truct.stacks=c;d.con$truct.index=0};b.registerSerializableFields=function(b){var a=arguments,c=a.length,e=[];if(b.declared$Fields)for(var f=0;f<b.declared$Fields.length;f++)e[f]=b.declared$Fields[f];b.declared$Fields=e;if(0<c&&1==c%2){e=b.declared$Fields;c=(c-1)/2;for(f=1;f<=c;f++){for(var g={name:a[f+f-1],type:a[f+f]},l=!1,k=0;k<e.length;k++)if(e[k].name==
g.name){e[k].type=g.type;l=!0;break}l||e.push(g)}}};b.getMixedCallerMethod=function(d){var a={};if((d=d.callee.caller)&&d!==b.tryToSearchAndExecute)d=d.arguments.callee.caller;if(d!==b.tryToSearchAndExecute||(d=d.arguments.callee.caller)!==b.searchAndExecuteMethod)return null;a.claxxRef=d.arguments[1];a.fxName=d.arguments[2];a.paramTypes=b.getParamsType(d.arguments[3]);d=d.arguments.callee.caller&&d.arguments.callee.caller;if(!d)return null;a.caller=d;return a};c$=null;b.cStack=[];b.pu$h=function(d){d&&
b.cStack.push(d)};b.p0p=function(){return b.cStack.pop()};b.tracingCalling=!1;b._initializingException=!1;b.callingStack=function(b,a){this.caller=b;this.owner=a};b._callingStackTraces=[];java.lang.Object=b._O;b._O.getName=b._innerFunctions.getName;System={props:null,$props:{},arraycopy:function(b,a,c,e,f){if(b!==c)for(var g=0;g<f;g++)c[e+g]=b[a+g];else{for(var l=[],g=0;g<f;g++)l[g]=b[a+g];for(g=0;g<f;g++)c[e+g]=l[g]}},currentTimeMillis:function(){return(new Date).getTime()},gc:function(){},getProperties:function(){return System.props},
getProperty:function(b,a){if(System.props)return System.props.getProperty(b,a);var c=System.$props[b];return c?c:1==arguments.length?null:a?a:b},getSecurityManager:function(){return null},setProperties:function(b){System.props=b},setProperty:function(b,a){if(!System.props)return System.$props[b]=a;System.props.setProperty(b,a)}};System.setProperty("line.separator",0<=navigator.userAgent.indexOf("Windows")?"\r\n":"\n");System.setProperty("os.name",navigator.userAgent);System.out=new b._O;System.out.__CLASS_NAME__=
"java.io.PrintStream";System.out.print=function(){};System.out.printf=function(){};System.out.println=function(){};System.out.write=function(){};System.err=new b._O;System.err.__CLASS_NAME__="java.io.PrintStream";System.err.print=function(){};System.err.printf=function(){};System.err.println=function(){};System.err.write=function(){};b.popup=b.assert=b.log=b.error=window.alert;Thread=function(){};Thread.J2S_THREAD=Thread.prototype.J2S_THREAD=new Thread;Thread.currentThread=Thread.prototype.currentThread=
...
[],[],java.lang.reflect.Modifier.PUBLIC)};b._innerFunctions.getDeclaredMethods=b._innerFunctions.getMethods=function(){var b=[],a=this.prototype,c;for(c in a)"function"==typeof a[c]&&!a[c].__CLASS_NAME__&&b.push(new java.lang.reflect.Method(this,c,[],java.lang.Void,[],java.lang.reflect.Modifier.PUBLIC));a=this;for(c in a)"function"==typeof a[c]&&!a[c].__CLASS_NAME__&&b.push(new java.lang.reflect.Method(this,c,[],java.lang.Void,[],java.lang.reflect.Modifier.PUBLIC|java.lang.reflect.Modifier.STATIC));
return b};b._innerFunctions.getDeclaredMethod=b._innerFunctions.getMethod=function(b){var a=this.prototype,c;for(c in a)if(b==c&&"function"==typeof a[c]&&!a[c].__CLASS_NAME__)return new java.lang.reflect.Method(this,c,[],java.lang.Void,[],java.lang.reflect.Modifier.PUBLIC);a=this;for(c in a)if(b==c&&"function"==typeof a[c]&&!a[c].__CLASS_NAME__)return new java.lang.reflect.Method(this,c,[],java.lang.Void,[],java.lang.reflect.Modifier.PUBLIC|java.lang.reflect.Modifier.STATIC);return null};b._innerFunctions.getModifiers=
function(){return java.lang.reflect.Modifier.PUBLIC};b._innerFunctions.newInstance=function(){return new this};k=b.innerFunctionNames;for(f=0;f<k.length;f++)b._O[k[f]]=b._innerFunctions[k[f]],Array[k[f]]=b._innerFunctions[k[f]];b.cleanDelegateMethod=function(b){b&&("function"==typeof b&&b.lastMethod&&b.lastParams&&b.lastClaxxRef)&&(b.lastMethod=null,b.lastParams=null,b.lastClaxxRef=null)};b.unloadClass=function(d){var a=b.evalType(d);if(a){b.unloadedClasses[d]=a;for(var c=d.split(/\./),e=null,f=0;f<
c.length-1;f++)e=e?e[c[f]]:b.allPackage[c[0]];if(e)for(g in e[c[c.length-1]]=null,e)0==g.indexOf(c[c.length-1]+"$")&&(b.unloadClass(e.__PKG_NAME__+"."+g),e[g]=null);else{b.allPackage[c[0]]=null;window[c[0]]=null;for(var g in window)0==g.indexOf(d+"$")&&(b.unloadClass(g),window[g]=null)}if(b.allClasses[d])for(g in b.allClasses[d]=!1,b.allClasses)0==g.indexOf(d+"$")&&(b.allClasses[g]=!1);for(var l in a)b.cleanDelegateMethod(a[l]);for(l in a.prototype)b.cleanDelegateMethod(a.prototype[l]);b._Loader&&
b._Loader.unloadClassExt(d);return!0}return!1}}b._Loader=function(){};b._Node=function(){b._Loader.initNode(this)};(function(b,a,c){a.initNode=function(a){a.parents=[];a.musts=[];a.optionals=[];a.declaration=null;a.name=null;a.path=null;a.requires=null;a.requiresMap=null;a.onRequiredLoaded=null;a.status=0;a.random=0.13412};c.prototype.toString=function(){return this.name||this.path||"ClazzNode"};c.STATUS_UNKNOWN=0;c.STATUS_KNOWN=1;c.STATUS_CONTENT_LOADED=2;c.STATUS_MUSTS_LOADED=3;c.STATUS_DECLARED=
4;c.STATUS_OPTIONALS_LOADED=5;a.loaders=[];a.requireLoaderByBase=function(b){for(var c=0;c<a.loaders.length;c++)if(a.loaders[c].base==b)return a.loaders[c];c=new a;c.base=b;a.loaders.push(c);return c};a.clazzTreeRoot=new c;a.loadedScripts={};a.inLoadingThreads=0;a.maxLoadingThreads=6;a.userAgent=navigator.userAgent.toLowerCase();a.isOpera=-1!=a.userAgent.indexOf("opera");a.isIE=-1!=a.userAgent.indexOf("msie")&&!a.isOpera;a.isGecko=-1!=a.userAgent.indexOf("gecko");if(a.isOpera){a.maxLoadingThreads=
1;var e=a.userAgent.indexOf("opera/");if(-1!=e){var f=9;try{f=parseFloat(a.userAgent.subString(e+6))}catch(g){}9.6<=f&&(a.maxLoadingThreads=6)}}window.Clazz&&b.isClassDefined?a.isClassDefined=b.isClassDefined:(a.definedClasses={},a.isClassDefined=function(b){return!0==a.definedClasses[b]});a.unwrapArray=function(a){if(!a||0==a.length)return[];for(var b=null,c=0;c<a.length;c++)if(a[c]){if("$"==a[c].charAt(0))if("."==a[c].charAt(1)){if(!b)continue;var d=b.lastIndexOf(".");-1!=d&&(b=b.substring(0,d),
a[c]=b+a[c].substring(1))}else a[c]="org.eclipse.s"+a[c].substring(1);b=a[c]}return a};a.classQueue=[];a.classpathMap={};a.loadPackageClasspath=function(b,c,d,e,f,g){var j=a.classpathMap;f||(f=0);e||(e=null);g||(g=0);var k=d&&j["@"+b];if(0==f&&(d&&!j["@java"]&&0!=b.indexOf("java")&&a.needPackage("java"))&&(a.loadPackage("java",e?function(){a.loadPackageClasspath(b,c,d,e,1)}:null),e))return;if(b instanceof Array)if(a.unwrapArray(b),e)g<b.length?a.loadPackageClasspath(b[g],c,d,function(){a.loadPackageClasspath(b,
c,d,e,1,g+1)},1):e();else for(j=0;j<b.length;j++)a.loadPackageClasspath(b[j],c,d,null);else{switch(b){case "java.*":b="java";case "java":c&&(f="@net.sf.j2s.ajax",j[f]||(j[f]=c),f="@net.sf.j2s",j[f]||(j[f]=c));break;case "swt":b="org.eclipse.swt";break;case "ajax":b="net.sf.j2s.ajax";break;case "j2s":b="net.sf.j2s";break;default:b.lastIndexOf(".*")==b.length-2&&(b=b.substring(0,b.length-2))}c&&(j["@"+b]=c);d&&!k&&!window[b+".registered"]?(a.pkgRefCount++,"java"==b&&(b="core"),a.loadClass(b+".package",
function(){0==--a.pkgRefCount&&a.runtimeLoaded()},!0,!0,1)):e&&e()}};a.loadClass=function(e,f,g,j,k){k||(k=0);null==j&&(j=!1);if("boolean"==typeof f)return b.evalType(e);a.needPackage("java")&&a.loadPackage("java");a.needPackage("core")&&a.loadPackage("core");a.keepOnLoading=!0;if(!g&&(a.pkgRefCount&&e.lastIndexOf(".package")!=e.length-8||0!=e.indexOf("java.")&&!a.isClassDefined(a.runtimeKeyClass)))a.queueBe4KeyClazz.push([e,f]);else if((g=a.isClassDefined(e))||a.isClassExcluded(e)){if(g&&f&&(e=a.findClass(e),
!e||e.status>=c.STATUS_OPTIONALS_LOADED))j?window.setTimeout(f,25):f()}else{var n=a.getClasspathFor(e);k=a.loadedScripts[n];j=a.classQueue;if(!k)for(g=j.length;0<=--g;)if(j[g].path==n||j[g].name==e){k=!0;break}if(k){if(f&&(k=a.findClass(e)))if(k.onRequiredLoaded){if(f!=k.onRequiredLoaded){var p=k.onRequiredLoaded;k.onRequiredLoaded=function(){p();f()}}}else k.onRequiredLoaded=f}else{k=b.unloadedClasses[e]&&a.findClass(e)||new c;k.name=e;k.path=n;k.isPackage=n.lastIndexOf("package.js")==n.length-10;
a.mappingPathNameNode(n,e,k);k.onRequiredLoaded=f;k.status=c.STATUS_KNOWN;e=!1;for(g=j.length;0<=--g;)if(j[g].status!=c.STATUS_OPTIONALS_LOADED){e=!0;break}if(k.isPackage){for(g=j.length;0<=--g&&!j[g].isPackage;)j[g+1]=j[g];j[++g]=k}else e&&j.push(k);if(!e){var q=!1;f&&(q=a.isLoadingEntryClass,a.isLoadingEntryClass=!0);a.addChildClassNode(a.clazzTreeRoot,k,!0);a.loadScript(k.path,k.requiredBy,!1,f?function(){a.isLoadingEntryClass=q;f()}:null)}}}};a.needPackage=function(b){return null!=window[b+".registered"]&&
!a.classpathMap["@"+b]};a.loadPackage=function(b,c){c||(c=null);window[b+".registered"]=!1;a.loadPackageClasspath(b,a.J2SLibBase||(a.J2SLibBase=a.getJ2SLibBase()||"j2s/"),!0,c)};a.pkgRefCount=0;a.jarClasspath=function(b,c){c instanceof Array||(c=[classes]);a.unwrapArray(c);for(var d=c.length;0<=--d;)a.classpathMap["#"+c[d]]=b;a.classpathMap["$"+b]=c};a.registerPackages=function(c,e){for(var f=a.getClasspathFor(c+".*",!0),g=0;g<e.length;g++)window.Clazz&&b.declarePackage(c+"."+e[g]),a.loadPackageClasspath(c+
"."+e[g],f)};a.getClasspathFor=function(c,e,f){var g=a.classpathMap["#"+c];if(!g||e||f){var j,k;if(g){if(c=c.replace(/\./g,"/"),0<=(k=g.lastIndexOf(c))||0<=(k=c.lastIndexOf("/"))&&0<=(k=g.lastIndexOf(c.substring(0,k))))j=g.substring(0,k)}else{for(k=c.length+2;0<=(k=c.lastIndexOf(".",k-2))&&!(j=a.classpathMap["@"+c.substring(0,k)]););e||(c=c.replace(/\./g,"/"))}null==j&&(j=window.Clazz&&b.binaryFolders&&b.binaryFolders.length?b.binaryFolders[0]:a.binaryFolders&&a.binaryFolders.length?a.binaryFolders[0]:
"j2s");g=(j.lastIndexOf("/")==j.length-1?j:j+"/")+(e?"":c.lastIndexOf("/*")==c.length-2?c.substring(0,k+1):c+(!f?".js":"."!=f.charAt(0)?"."+f:f))}return g};a.excludeClassMap={};a.ignore=function(){var b=1==arguments.length&&arguments[0]instanceof Array?b=arguments[0]:null,c=b?b.length:arguments.length;if(!b)for(var b=Array(c),d=0;d<c;d++)b[d]=arguments[d];a.unwrapArray(b);for(d=0;d<c;d++)a.excludeClassMap["@"+b[d]]=1};a.isClassExcluded=function(b){return a.excludeClassMap["@"+b]};a.onScriptLoading=
function(){};a.onScriptLoaded=function(){};a.onScriptInitialized=function(){};a.onScriptCompleted=function(){};a.onClassUnloaded=function(){};a.onGlobalLoaded=function(){};a.keepOnLoading=!0;a.mapPath2ClassNode={};a.evaluate=function(c,e){try{eval(e)}catch(f){var g="[Java2Script] Script error: "+f.message+" \n"+c+"\n\n"+e;alert(g);b.alert(g);throw f;}a.onScriptLoaded(c);a.tryToLoadNext(c)};a.failedHandles={};a.generateRemovingFunction=function(a){return function(){if("interactive"!=a.readyState){try{a.parentNode&&
a.parentNode.removeChild(a)}catch(b){}a=null}}};a.removeScriptNode=function(b){window["j2s.script.debugging"]||window.setTimeout(a.generateRemovingFunction(b),1)};b._4Name=function(c,e,f){if(b.isClassDefined(c))return b.evalType(c);e=Jmol._isAsync&&e?e._restoreState(c,f):null;if(1==e)return null;if(a.setLoadingMode(e?a.MODE_SCRIPT:"xhr.sync"))return a.loadClass(c,e,!1,!0,1),null;a.loadClass(c);return b.evalType(c)};a.loadScript=function(c,e,f,g){b.currentPath=c;!f&&a.loadedScripts[c]?a.tryToLoadNext(c):
(a.loadedScripts[c]=!0,b.removeArrayItem(a.classQueue,c),System.out.println("\t"+c+(e?"\n -- required by "+e:"")+"  ajax="+a.isUsingXMLHttpRequest+" async="+a.isAsynchronousLoading),a.onScriptLoading(c),a.isUsingXMLHttpRequest&&!a.isAsynchronousLoading?(e=Jmol._getFileData(c),a.evaluate(c,e)):(e={dataType:"script",async:!0,type:"GET",url:c,success:a.W3CScriptOnCallback(c,!1,g),error:function(){a.W3CScriptOnCallback(c,!0,g)}},a.inLoadingThreads++,Jmol.$ajax(e)))};a.W3CScriptOnCallback=function(c,e,
f){return function(){e&&b.__debuggingBH&&b.alert("############ forError="+e+" path="+c+" ####"+(e?"NOT":"")+"LOADED###");a.isGecko&&this.timeoutHandle&&(window.clearTimeout(this.timeoutHandle),this.timeoutHandle=null);0<a.inLoadingThreads&&a.inLoadingThreads--;this.onerror=this.onload=null;e&&alert("There was a problem loading "+c);a.onScriptLoaded(c);var g=this,j=function(){a.removeScriptNode(g);f&&f()};0<=a.loadingTimeLag?window.setTimeout(function(){a.tryToLoadNext(c,j)},a.loadingTimeLag):a.tryToLoadNext(c,
j)}};a.isLoadingEntryClass=!0;a.besidesJavaPackage=!1;a.tryToLoadNext=function(b,d){var e=a.mapPath2ClassNode["@"+b];if(e){var f,g=a.classpathMap["$"+b];if(g)for(var j=0;j<g.length;j++){var k=g[j];if(k!=e.name&&(f=a.findClass(k)))f.status<c.STATUS_CONTENT_LOADED&&(f.status=c.STATUS_CONTENT_LOADED,a.updateNode(f));else{f=new c;f.name=k;var n=a.classpathMap["#"+k];n||(alert(k+" J2S error in tryToLoadNext"),error("Java2Script implementation error! Please report this bug!"));f.path=n;a.mappingPathNameNode(f.path,
k,f);f.status=c.STATUS_CONTENT_LOADED;a.addChildClassNode(a.clazzTreeRoot,f,!1);a.updateNode(f)}}if(e instanceof Array)for(j=0;j<e.length;j++)e[j].status<c.STATUS_CONTENT_LOADED&&(e[j].status=c.STATUS_CONTENT_LOADED,a.updateNode(e[j]));else if(e.status<c.STATUS_CONTENT_LOADED){f=!1;g=document.getElementsByTagName("SCRIPT");for(j=0;j<g.length;j++)if(a.isIE){if(g[j].onreadystatechange&&g[j].onreadystatechange.path==e.path&&"interactive"==g[j].readyState){f=!0;break}}else if(g[j].onload&&g[j].onload.path==
e.path){f=!0;break}f||(e.status=c.STATUS_CONTENT_LOADED,a.updateNode(e))}if(a.keepOnLoading){e=!0;if(f=a.findNextMustClass(c.STATUS_KNOWN))for(a.loadClassNode(f);a.inLoadingThreads<a.maxLoadingThreads&&(f=a.findNextMustClass(c.STATUS_KNOWN));)a.loadClassNode(f);else if(0!=(j=a.classQueue).length)f=j.shift(),!a.loadedScripts[f.path]||0!=j.length||!a.isLoadingEntryClass||f.musts.length||f.optionals.length?(a.addChildClassNode(a.clazzTreeRoot,f,!0),a.loadScript(f.path,f.requiredBy)):a.isLoadingEntryClass&&
(a.isLoadingEntryClass=!1);else if(f=a.findNextRequiredClass(c.STATUS_KNOWN))for(a.loadClassNode(f);a.inLoadingThreads<a.maxLoadingThreads&&(f=a.findNextRequiredClass(c.STATUS_KNOWN));)a.loadClassNode(f);else e=!1;if(!(e||0<a.inLoadingThreads)){e=[a.findNextMustClass,a.findNextRequiredClass];g=null;for(j=0;2>j;j++)for(;f=e[j](c.STATUS_CONTENT_LOADED);)1==j&&g===f&&(f.status=c.STATUS_OPTIONALS_LOADED),a.updateNode(f),g=f;for(;!(a.tracks=[],!a.checkCycle(a.clazzTreeRoot)););for(j=0;2>j;j++)for(g=null;(f=
e[j](c.STATUS_DECLARED))&&g!==f;)a.updateNode(g=f);g=[];for(j=0;2>j;j++)for(;f=e[j](c.STATUS_DECLARED);)g.push(f),f.status=c.STATUS_OPTIONALS_LOADED;if(g.length){for(j=0;j<g.length;j++)a.destroyClassNode(g[j]);for(j=0;j<g.length;j++)if(e=g[j].onRequiredLoaded)g[j].onRequiredLoaded=null,e()}a.onGlobalLoaded();d&&d()}}}};a.tracks=[];a.checkCycle=function(b){for(var d=a.tracks,e=d.length,f=e;0<=--f&&!(d[f]===b&&d[f].status>=c.STATUS_DECLARED););d.push(b);if(0<=f){for(;f<d.length;f++){d[f].status=c.STATUS_OPTIONALS_LOADED;
a.destroyClassNode(d[f]);for(e=0;e<d[f].parents.length;e++)a.updateNode(d[f].parents[e]);d[f].parents=[];if(e=d[f].onRequiredLoaded)d[f].onRequiredLoaded=null,e()}d.length=0;return!0}b=[b.musts,b.optionals];for(var g=0;2>g;g++)for(var j=b[g],f=j.length;0<=--f;)if(j[f].status==c.STATUS_DECLARED&&a.checkCycle(j[f]))return!0;d.length=e;return!1};a.updateNode=function(b){if(!b.name||b.status>=c.STATUS_OPTIONALS_LOADED)a.destroyClassNode(b);else{var d=!0;if(b.musts.length&&b.declaration)for(var e=b.musts.length,
f=e;0<=--f;){var g=b.musts[f];g.requiredBy=b;if(g.status<c.STATUS_DECLARED&&a.isClassDefined(g.name)){var j=[];g.status=c.STATUS_OPTIONALS_LOADED;a.destroyClassNode(g);if(g.declaration&&g.declaration.clazzList){for(var k=0,n=g.declaration.clazzList,p=n.length;k<p;k++){var q=a.findClass(n[k]);q&&(q.status!=c.STATUS_OPTIONALS_LOADED&&q!==g)&&(q.status=g.status,q.declaration=null,a.destroyClassNode(q),q.onRequiredLoaded&&j.push(q))}g.declaration=null}g.onRequiredLoaded&&j.push(g);for(k=0;k<j.length;k++)if(n=
j[k].onRequiredLoaded)j[k].onRequiredLoaded=null,n()}else g.status==c.STATUS_CONTENT_LOADED&&a.updateNode(g),g.status<c.STATUS_DECLARED&&(d=!1);b.musts.length!=e&&(f=e=b.musts.length,d=!0)}if(d){if(b.status<c.STATUS_DECLARED){if(k=b.declaration)k(),k.executed=!0;b.status=c.STATUS_DECLARED;a.definedClasses&&(a.definedClasses[b.name]=!0);a.onScriptInitialized(b.path);if(b.declaration&&b.declaration.clazzList){k=0;n=b.declaration.clazzList;for(p=n.length;k<p;k++)if((q=a.findClass(n[k]))&&q.status!=c.STATUS_DECLARED&&
...
"red")};q.err.println=function(b){n.consoleOutput("undefined"==typeof b?"\r\n":null==b?"null\r\n":b+"\r\n","red")};q.err.write=function(b,a,c){q.err.print(String.instantialize(b).substring(a,a+c))}}(Clazz))};Jmol.___JmolDate="$Date: 2015-03-23 07:22:00 -0600 (Mon, 23 Mar 2015) $";Jmol.___fullJmolProperties="src/org/jmol/viewer/Jmol.properties";Jmol.___JmolVersion="14.2.13_2015.03.23";
